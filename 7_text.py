...
#화면 타이틀 설정
pygame.display.set_caption("Seungame") #게임 이름

# FPS
clock = pygame.time.Clock()

#배경 이미지 불러오기
background = pygame.image.load("C:/Software/CSE 310/W05/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Software/CSE 310/W05/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Software/CSE 310/W05/enemy.png")
...
while running:
    ...
    print(f"Character Rect: {character_rect}")
    print(f"Enemy Rect: {enemy_rect}")
